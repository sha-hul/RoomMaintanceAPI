...
namespace RoomMaintenanceAPI.Models
{
    ...
    public static class ErrorHandler
    {
        ...
        public static async Task<IActionResult> HandleExceptionAsync(Exception ex, IDbContextTransaction transaction, DbContext context, object dto,
            string apiName, string controllerName, string errorCode, string empId)
        {
            if (transaction != null)
